...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>public/plugins/sweetalert2/dist/sweetalert2.min.css">
...
<body class="hold-transition sidebar-mini layout-footer-fixed layout-navbar-fixed">
  ...
  ?>
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?=base_url()?>public/index3.html" class="brand-link">
                <img src="<?=base_url()?>public/img/logo.png" alt="AdminLTE Logo" class="brand-image elevation-5"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">SPK Sistem Pemilihan</span>
            </a>
       ...
       ?>
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <b>SPK Sistem Pemilihan Pelanggan</b>
            </div>
            <strong>Copyright &copy; 2021 Nurjanah
        </footer>
    ...
    <script src="<?=base_url()?>public/plugins/angular-base64-upload/dist/angular-base64-upload.min.js"></script>
    <script src="<?=base_url()?>public/plugins/swangular/swangular.js"></script>
    <!-- AdminLTE App -->
